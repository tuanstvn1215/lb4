...
describe('log extension acceptance test', () => {
    let app;
    let spy;
    class LogApp extends (0, __1.LogMixin)(rest_1.RestApplication) {
    }
    ...
    beforeEach(() => {
        spy = (0, log_spy_1.createLogSpy)();
    });
    afterEach(() => (0, log_spy_1.restoreLogSpy)(spy));
    it('logs information at DEBUG or higher', async () => {
        setAppLogToDebug();
        const client = (0, testlab_1.createClientForHandler)(app.requestHandler);
        await client.get('/nolog').expect(200, 'nolog called');
        (0, testlab_1.expect)(spy.called).to.be.False();
    ...
    function createSequence() {
        ...
        LogSequence = tslib_1.__decorate([
            ...
            tslib_1.__param(5, (0, core_1.inject)(__1.EXAMPLE_LOG_BINDINGS.LOG_ACTION)),
